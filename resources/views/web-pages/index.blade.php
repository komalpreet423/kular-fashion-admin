                                ...
                                <tbody>
                                    @foreach ($webPages as $key => $webPage)
                                        <tr>
                                            ...
                                            <td>{{ $webPage->slug }}</td>
                                            <td>
                                                <span class="badge bg-{{ $webPage->hide_categories ? 'danger' : 'success' }}">
                                                    {{ $webPage->hide_categories ? 'Yes' : 'No' }}
                                                </span>
                                            </td>
                                            <td>
                                                <span class="badge bg-{{ $webPage->show_all_filters ? 'success' : ($webPage->hide_all_filters ? 'danger' : 'secondary') }}">
