...
<head>
    ...
    <style>
        @font-face {
            ...
            font-style: normal;
            font-weight: 600;
            src: url('https://fonts.gstatic.com/s/poppins/v23/pxiByp8kv8JHgFVrLEj6Z1JlEw.woff') format('woff'), url('https://fonts.gstatic.com/s/poppins/v23/pxiByp8kv8JHgFVrLEj6Z1JlFQ.woff2') format('woff2');
        }
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 500;
            src: url('https://fonts.gstatic.com/s/poppins/v23/pxiByp8kv8JHgFVrLGT9Z1JlEw.woff') format('woff'), url('https://fonts.gstatic.com/s/poppins/v23/pxiByp8kv8JHgFVrLGT9Z1JlFQ.woff2') format('woff2');
        }
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 400;
            src: url('https://fonts.gstatic.com/s/poppins/v23/pxiEyp8kv8JHgFVrJJnedA.woff') format('woff'), url('https://fonts.gstatic.com/s/poppins/v23/pxiEyp8kv8JHgFVrJJnecg.woff2') format('woff2');
        }
    </style>
    <!--<![endif]-->
    <!--[if mso]>
...
<body class="body pc-font-alt"
    ...
    <table class="pc-project-body"
        style="table-layout: fixed; width: 100%; min-width: 600px; background-color: #ffffff;" bgcolor="#ffffff"
        border="0" cellspacing="0" cellpadding="0" role="presentation">
        <tr>
            <td align="center" valign="top" style="width:auto;">
                <table class="pc-project-container" align="center" style="width: 600px; max-width: 600px;"
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td valign="top" class="pc-w620-padding-24-0-0-0"
                                                                style="height: unset; background-color: #ffffff;"
                                                                bgcolor="#ffffff">
                                                                                                                ...
                                                                                                                <table
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        <td class="pc-w620-halign-center"
                                                                                                                            align="left"
                                                                                                                            valign="top">
                                                                                                                            <img src="images/6bcf4080513af0370392a31b2b1e5af4.png"
                                                                                                                                ...
                                                                                                                                <tr>
                                                                                                                                    <td style="width:unset;"
                                                                                                                                        ...
                                                                                                                                        <table
                                                                                                                                            ...
                                                                                                                                            <tr
                                                                                                                                                class="pc-grid-tr-first pc-grid-tr-last">
                                                                                                                                                <td class="pc-grid-td-first pc-w620-itemsSpacings-24-0"
                                                                                                                                                    valign="middle"
                                                                                                                                                                                            ...
                                                                                                                                                                                            <tr>
                                                                                                                                                                                                <td valign="top"
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    <a class="pc-font-alt pc-w620-textAlign-center"
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        target="_blank"
                                                                                                                                                                                                        style="display: block; text-decoration: none; line-height: 140%; letter-spacing: 0px; font-family: 'Poppins', Arial, Helvetica, sans-serif; font-size: 14px; font-weight: normal; color: #001942; text-align: center; text-align-last: center;">
                                                                                                                                                                                                        <span>Track
                                                                                                                                                                                                            Package</span>
                                                                                                                                                                                                    </a>
                                                                                                                                                                                                </td>
                                                                ...
                                                                <table class="pc-width-fill pc-w620-gridCollapsed-0"
                                                                    ...
                                                                    <tr class="pc-grid-tr-first pc-grid-tr-last">
                                                                        <td class="pc-grid-td-first pc-grid-td-last"
                                                                            ...
                                                                            <table style="width: 100%;" border="0"
                                                                                ...
                                                                                role="presentation">
                                                                                <tr>
                                                                                    <td class="pc-w620-padding-40-24-40-24"
                                                                                        align="center" valign="bottom"
                                                                                        style="padding: 44px 44px 44px 44px; height: auto; background-color: #ecf1fb; border-radius: 10px 10px 10px 10px;">
                                                                                        <table align="center"
                                                                                            width="100%"
                                                                                            border="0"
                                                                                            cellpadding="0"
                                                                                                ...
                                                                                                <td align="center"
                                                                                                    ...
                                                                                                    <table
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td align="center"
                                                                                                                valign="top"
                                                                                                                style="padding: 0px 0px 32px 0px; height: auto;">
                                                                                                                <img src="images/image-1719380710757.png"
                                                                                                                    width="150"
                                                                                                                    height="162"
                                                                                                                    alt=""
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        <td valign="top"
                                                                                                                            ...
                                                                                                                            <div class="pc-font-alt pc-w620-fontSize-32px pc-w620-lineHeight-32"
                                                                                                                                style="line-height: 100%; letter-spacing: -0.03em; font-family: 'Poppins', Arial, Helvetica, sans-serif; font-size: 40px; font-weight: 600; color: #001942; text-align: center; text-align-last: center;">
                                                                                                                                <div>
                                                                                                                                    <span>Thanks
                                                                                                                                        for
                                                                                                                                        the
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        <td valign="top"
                                                                                                                            ...
                                                                                                                            <div class="pc-font-alt pc-w620-fontSize-14px pc-w620-lineHeight-140pc"
                                                                                                                                style="line-height: 140%; letter-spacing: 0px; font-family: 'Poppins', Arial, Helvetica, sans-serif; font-size: 14px; font-weight: normal; color: #001942; text-align: center; text-align-last: center;">
                                                                                                                                <div>
                                                                                                                                    <span
                                                                                                                                        style="letter-spacing: 0px;">Great
                                                                                                                                        news!
                                                                                                                                        Your
                                                                                                                                        order
                                                                                                                                        is
                                                                                                ...
                                                                                                <td align="center"
                                                                                                    ...
                                                                                                    <table
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <th valign="top"
                                                                                                                align="center"
                                                                                                                style="text-align: center; font-weight: normal; line-height: 100%;">
                                                                                                                <!--[if mso]>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td valign="top" class="pc-w620-padding-30-0-30-0"
                                                                style="padding: 44px 0px 44px 0px; height: unset; background-color: #ffffff;"
                                                                bgcolor="#ffffff">
                                                                <table class="pc-w620-width-fill" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td class="pc-w620-spacing-0-0-0-0">
                                                                            <table
                                                                                class="pc-width-fill pc-w620-gridCollapsed-0 pc-w620-width-fill"
                                                                                width="100%" height="100%"
                                                                                border="0" cellpadding="0"
                                                                                cellspacing="0" role="presentation">
                                                                                <tr
                                                                                                            ...
                                                                                                            <td align="center"
                                                                                                                ...
                                                                                                                <table
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        <td align="center"
                                                                                                                            valign="top"
                                                                                                                            style="padding: 0px 0px 12px 0px; height: auto;">
                                                                                                                            <img src="images/5b305647c0f5e5a664d2cca777f34bf4.png"
                                                                                                                                class="pc-w620-width-38 pc-w620-height-auto"
                                                                                                                                width="38"
                                                                                                                                height="38"
                                                                                                                                alt=""
                                                                                                                                ...
                                                                                                                                <tr>
                                                                                                                                    <td valign="top"
                                                                                                                                        ...
                                                                                                                                        <div class="pc-font-alt pc-w620-fontSize-14px"
                                                                                                                                            style="line-height: 133%; letter-spacing: -0.2px; font-family: 'Poppins', Arial, Helvetica, sans-serif; font-size: 14px; font-weight: normal; color: #0067ff; text-align: center; text-align-last: center;">
                                                                                                                                            <div>
                                                                                                                                                <span>Confirmed</span>
                                                                                                                                            </div>
                                                                                                                                        </div>
                                                                                    ...
                                                                                    <td class="pc-w620-itemsSpacings-0-30"
                                                                                        align="center" valign="middle"
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td align="center"
                                                                                                                ...
                                                                                                                <table
                                                                                                                    ...
                                                                                                                    role="presentation">
                                                                                                                    <tr>
                                                                                                                        <td class="pc-w620-spacing-0-0-34-0"
                                                                                                                            valign="top"
                                                                                                                            style="padding: 0px 0px 32px 0px;">
                                                                                                                            <table
                                                                                                                                class="pc-w620-width-60"
                                                                                                                                width="87"
                                                                                                                                border="0"
                                                                                                                                cellpadding="0"
                                                                                                                                cellspacing="0"
                                                                                    ...
                                                                                    <td class="pc-w620-itemsSpacings-0-30"
                                                                                        ...
                                                                                        <table
                                                                                            ...
                                                                                            role="presentation">
                                                                                            <tr>
                                                                                                <td class="pc-w620-padding-0-6-0-6"
                                                                                                    align="center"
                                                                                                    valign="bottom">
                                                                                                    <table
                                                                                                        align="center"
                                                                                                                ...
                                                                                                                <table
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        <td align="center"
                                                                                                                            valign="top"
                                                                                                                            style="padding: 0px 0px 12px 0px; height: auto;">
                                                                                                                            <img src="images/99e51c88245905d275cf11b1e90194ab.png"
                                                                                                                                class="pc-w620-width-38 pc-w620-height-auto"
                                                                                                                                width="38"
                                                                                                                                height="38"
                                                                                                                                alt=""
                                                                                                                            ...
                                                                                                                            <table
                                                                                                                                ...
                                                                                                                                <tr>
                                                                                                                                    <td valign="top"
                                                                                                                                        align="center">
                                                                                                                                        <div class="pc-font-alt pc-w620-fontSize-14px"
                                                                                                                                            style="line-height: 133%; letter-spacing: -0.2px; font-family: 'Poppins', Arial, Helvetica, sans-serif; font-size: 14px; font-weight: normal; color: #53627a; text-align: center; text-align-last: center;">
                                                                                                                                            <div>
                                                                                                                                                <span>Shipping</span>
                                                                                                                                            </div>
                                                                                                                                        </div>
                                                                                                                ...
                                                                                                                <table
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        <td align="center"
                                                                                                                            valign="top"
                                                                                                                            style="padding: 0px 0px 12px 0px; height: auto;">
                                                                                                                            <img src="images/7af250fce78f428f47ab75eeda734977.png"
                                                                                                                                class="pc-w620-width-38 pc-w620-height-auto"
                                                                                                                                width="38"
                                                                                                                                height="38"
                                                                                                                                alt=""
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td valign="top"
                                                                ...
                                                                style="padding: 40px 24px 40px 24px; height: unset; border-radius: 20px 20px 20px 20px; background-color: #ecf1fb;"
                                                                bgcolor="#ecf1fb">
                                                                <table width="100%" border="0" cellpadding="0"
                                                                    cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td class="pc-w620-spacing-0-0-0-0"
                                                                            align="center" valign="top"
                                                                            style="padding: 0px 0px 8px 0px; height: auto;">
                                                                                ...
                                                                                <tr>
                                                                                    <td valign="top"
                                                                                        ...
                                                                                        <div class="pc-font-alt pc-w620-fontSize-24px pc-w620-lineHeight-40"
                                                                                            style="line-height: 100%; letter-spacing: -0.03em; font-family: 'Poppins', Arial, Helvetica, sans-serif; font-size: 24px; font-weight: 600; color: #001942; text-align: center; text-align-last: center;">
                                                                                            <div><span>Your item in this
                                                                                                    order </span>
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
                                                                ...
                                                                <table width="100%" border="0" cellpadding="0"
                                                                    cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td class="pc-w620-spacing-0-0-20-0"
                                                                            align="center" valign="top"
                                                                                ...
                                                                                <tr>
                                                                                    <td valign="top"
                                                                                        ...
                                                                                        <div class="pc-font-alt pc-w620-fontSize-16px pc-w620-lineHeight-28"
                                                                                            style="line-height: 140%; letter-spacing: 0px; font-family: 'Poppins', Arial, Helvetica, sans-serif; font-size: 14px; font-weight: normal; color: #001942; text-align: center; text-align-last: center;">
                                                                                            <div><span
                                                                                                    style="letter-spacing: 0px;">Order
                                                                                                    number:
                                                                                                    {{ $order->unique_order_id }}</span>
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                        ...
                                                                        <tr>
                                                                            <td style="padding: 0px 0px 20px 0px;">
                                                                                <table class="pc-w620-tableCollapsed-0"
                                                                                    ...
                                                                                    role="presentation"
                                                                                    bgcolor="#FFFFFF"
                                                                                    style="width: 100%; background-color:#FFFFFF; border-radius: 10px;">
                                                                                    <tr>
                                                                                        <td align="left"
                                                                                            valign="top"
                                                                                            style="padding: 16px;">
                                                                                            ...
                                                                                            <table width="100%"
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td width="100"
                                                                                                        ...
                                                                                                        <img src="{{ $item->product->image_url ?? 'images/image-1719404197122.png' }}"
                                                                                                            width="100"
                                                                                                            height="104"
                                                                                                            alt="{{ $item->product->name ?? 'Product' }}"
                                                                                                            style="display: block; width: 100px; height: 104px; border: 0;" />
                                                                                                    </td>

                                                                                                    <!-- Product Details -->
                                                                                                    <td valign="top">
                                                                                                        <div
                                                                                                            style="font-family: 'Poppins', Arial, Helvetica, sans-serif; font-size: 16px; font-weight: 600; color: #001942; margin-bottom: 8px;">
                                                                                                            {{ $item->product->name ?? 'Product Name' }}
                                                                                                        </div>

                                                                                                        <div
                                                                                                            style="font-family: 'Poppins', Arial, Helvetica, sans-serif; font-size: 14px; color: #53627a; margin-bottom: 4px;">
                                                                                                            Size:
                                                                                                            {{ $item->variant->sizes->sizeDetail->size ?? 'N/A' }}
                                                                                                        </div>
                                                                                                        ...
                                                                                                        <div
                                                                                                            style="font-family: 'Poppins', Arial, Helvetica, sans-serif; font-size: 14px; font-weight: normal; color: #001942;">
                                                                                                            Price:
                                                                                                    ...
                                                                                                    <td width="100"
                                                                                                        ...
                                                                                                        align="right">
                                                                                                        <div
                                                                                                            style="font-family: 'Poppins', Arial, Helvetica, sans-serif; font-size: 16px; color: #001942; text-align: right;">
                                                                                                            ${{ number_format($item->price, 2) }}
                                                                                                        </div>
                                                                                                    </td>
                                                                                                </tr>
                                                                            ...
                                                                            <table class="pc-w620-tableCollapsed-0"
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="left"
                                                                                            valign="middle"
                                                                                            style="padding: 16px 0px 16px 16px; height: auto;">
                                                                                            <table border="0"
                                                                                                cellpadding="0"
                                                                                                cellspacing="0"
                                                                                                role="presentation"
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td valign="top"
                                                                                                        ...
                                                                                                        <div class="pc-font-alt pc-w620-fontSize-16 pc-w620-lineHeight-26"
                                                                                                            style="line-height: 140%; letter-spacing: -0.03em; font-family: 'Poppins', Arial, Helvetica, sans-serif; font-size: 16px; font-weight: normal; color: #001942; text-align: left; text-align-last: left;">
                                                                                                            <div>
                                                                                                                <span>Subtotal</span>
                                                                                                            </div>
                                                                                                        </div>
                                                                                        ...
                                                                                        <td align="right"
                                                                                            valign="middle"
                                                                                            style="padding: 16px 16px 16px 16px; height: auto;">
                                                                                            <table border="0"
                                                                                                cellpadding="0"
                                                                                                cellspacing="0"
                                                                                                role="presentation"
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td valign="top"
                                                                                                        ...
                                                                                                        <div class="pc-font-alt pc-w620-fontSize-16 pc-w620-lineHeight-20"
                                                                                                            style="line-height: 140%; letter-spacing: -0.03em; font-family: 'Poppins', Arial, Helvetica, sans-serif; font-size: 16px; font-weight: normal; color: #001942; text-align: right; text-align-last: right;">
                                                                                                            <div>
                                                                                                        ...
                                                                                                        <table
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td valign="top"
                                                                                                                    align="left">
                                                                                                                    <div class="pc-font-alt pc-w620-fontSize-16 pc-w620-lineHeight-26"
                                                                                                                        style="line-height: 140%; letter-spacing: -0.03em; font-family: 'Poppins', Arial, Helvetica, sans-serif; font-size: 16px; font-weight: 600; color: #001942; text-align: left; text-align-last: left;">
                                                                                                                        <div>
                                                                                                                            <span>Total</span>
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                            ...
                                                                                            <table border="0"
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td valign="top"
                                                                                                        align="right">
                                                                                                        <div class="pc-font-alt pc-w620-fontSize-16 pc-w620-lineHeight-20"
                                                                                                            style="line-height: 140%; letter-spacing: -0.03em; font-family: 'Poppins', Arial, Helvetica, sans-serif; font-size: 16px; font-weight: 600; color: #001942; text-align: right; text-align-last: right;">
                                                                                                            <div>
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        <td valign="top"
                                                                                                                            ...
                                                                                                                            <div class="pc-font-alt"
                                                                                                                                style="line-height: 140%; letter-spacing: -0.2px; font-family: 'Poppins', Arial, Helvetica, sans-serif; font-size: 16px; font-weight: 600; color: #001942; text-align: left; text-align-last: left;">
                                                                                                                                <div>
                                                                                                                                    <span>Shipping
                                                                                                                                        Address</span>
                                                                                                                                </div>
                                                                                                    ...
                                                                                                    <table
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td valign="top"
                                                                                                                align="left">
                                                                                                                <div class="pc-font-alt"
                                                                                                                    style="line-height: 140%; letter-spacing: 0px; font-family: 'Poppins', Arial, Helvetica, sans-serif; font-size: 14px; font-weight: normal; color: #001942; text-align: left; text-align-last: left;">
                                                                                                                    <div>
                                                                                                                        <span>Gregory
                                                                                                                            Swanson
                                                                                                                            26
                                        ...
                                        <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td align="center" valign="top"
                                                    ...
                                                    <a href="https://postcards.email/?uid=MzEyODU1&type=footer"
                                                        target="_blank"
                                                        style="text-decoration: none; overflow: hidden; border-radius: 2px; display: inline-block;">

                                                    </a>
                                                    <img src="https://api-postcards.designmodo.com/tracking/mail/promo?uid=MzEyODU1"
