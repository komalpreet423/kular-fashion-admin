<li style="width:{{ 100 - ($level * 1) }}%; margin-left:{{ $level * 1 }}%;">
    <div style="border:1px solid #00000030; border-radius:6px; background:#f6f6f9; margin:5px 0; padding:8px; display:flex; justify-content:space-between; align-items:center;">
